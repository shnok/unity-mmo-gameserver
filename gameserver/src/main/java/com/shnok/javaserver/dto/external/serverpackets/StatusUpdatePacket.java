...
public class StatusUpdatePacket extends SendablePacket {
    ...
    public static final int P_EVASION = 0x14;
    public static final int P_ACCURACY = 0x15;
    public static final int P_CRITICAL = 0x16;
    ...
    public static final int M_ACCURACY = 0x1C;
    public static final int M_EVASION = 0x1D;
    public static final int M_CRITICAL = 0x1E;
