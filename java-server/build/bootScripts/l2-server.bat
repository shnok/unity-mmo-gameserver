...
set JARPATH=%APP_HOME%\lib\l2-server-1.0.0.jar

@rem Execute l2-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %L2_SERVER_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%L2_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
